...
import { getUserLocally, removeUser, saveUser } from '@src/localStorage/userLocalStorage';
...
export default function useAuth(): UseAuth {
    ...
    }, [getUser, getUser.data, getUser?.data?.data, getUser.fetchStatus, getUser.isFetched, getUser.isLoading, navigate])
