    ...
    <>
      {useEmail ? (
        <form>
          ...
          <div className="flex gap-4">
            <FormInput
              ...
              placeholder="Name"
              onChange={(event) =>
                handleSetRegisterData("name", event.target.value)
              }
            />
            <FormInput
              label="username"
              ...
              minLength={4}
              onChange={(event) =>
                handleSetRegisterData("username", event.target.value)
              }
            />
          </div>
          ...
          <div>
            ...
            <Input.Password
              ...
              onChange={(event) =>
                handleSetRegisterData("password", event.target.value)
              }
            />
          </div>
          <div className="flex gap-3 flex-wrap md:flex-nowrap items-center mb-10">
            ...
            <FormSelect
              label="City"
              options={cityOptions}
              onChange={(value: never) => handleSetRegisterData("city", value)}
            />
          </div>
        ...
        <div className="relative">
          ...
          <BlockButton onClick={() => setUseEmail(true)}>Continue</BlockButton>
        </div>
      )}
      <ToastContainer />
    </>
